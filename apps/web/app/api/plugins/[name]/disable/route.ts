...
import { disablePlugin } from '@netpro/core/src/plugins/runtime';

export async function POST(_request: Request, { params }: { params: Promise<{ name: string }> }): Promise<Response> {
  try {
