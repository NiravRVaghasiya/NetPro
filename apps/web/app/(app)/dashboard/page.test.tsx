...
describe("/dashboard Content strip (v2.5 Phase 5 + 6)", () => {
  ...
  it("renders the tracker totals, the top pieces and the platform mix once items exist", async () => {
    insertContacts();
    const { upsertContentItem, recordMetrics } =
    ...
    const seeded = [
      ...
      {
        url: "https://example.dev/blog/two",
        title: "The second post",
        platform: "blog",
        publishedAt: NOW,
      },
      {
        url: "https://dev.to/ada/three",
        title: "A devto post",
        platform: "devto",
        publishedAt: NOW,
      },
    ...
    expect(html).toContain(
      "3 items · 1 measured · 1,200 latest-known views · 2 on Blog, 1 on dev.to.",
    );
