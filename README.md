...
**v1.0 Phases 1–2 are implemented** on top of the v0.1-alpha scaffold:
...
— network analytics, AI outreach, profile card, one-click Vercel deploy — are
still stubs; each becomes its own future spec built on this foundation.
...
for what Phase 1 covers and why.
...
- `packages/core` — shared business logic: import, enrichment, export, and faceted search pipelines (analytics/AI/CRM modules remain placeholders)
