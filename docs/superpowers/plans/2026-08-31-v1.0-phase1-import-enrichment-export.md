...
function createTestConn(): SqliteConn {
  ...
  sqlite.exec(`
    CREATE TABLE contacts (
      id TEXT PRIMARY KEY, full_name TEXT NOT NULL, email TEXT, company TEXT,
      company_domain TEXT, role TEXT, seniority TEXT, location TEXT, country TEXT,
      linkedin_url TEXT, github_url TEXT, twitter_url TEXT, industry TEXT,
      email_verified INTEGER DEFAULT 0, source TEXT NOT NULL,
...
function createTestConn(): SqliteConn {
  ...
  sqlite.exec(`
    CREATE TABLE contacts (
      ...
      email TEXT, company TEXT, role TEXT, seniority TEXT, location TEXT,
      linkedin_url TEXT, source TEXT NOT NULL, created_at TEXT NOT NULL, updated_at TEXT NOT NULL
    );
  `);
  return { dialect: 'sqlite', db, schema };
}
...
function createTestConn(): SqliteConn {
  ...
  sqlite.exec(`
    CREATE TABLE contacts (
      id TEXT PRIMARY KEY, full_name TEXT NOT NULL, email TEXT, company TEXT,
      company_domain TEXT, linkedin_url TEXT, source TEXT NOT NULL,
      created_at TEXT NOT NULL, updated_at TEXT NOT NULL
    );
  `);
...
function createTestConn(): SqliteConn {
  ...
  sqlite.exec(`
    CREATE TABLE contacts (
      id TEXT PRIMARY KEY, full_name TEXT NOT NULL, email TEXT, company TEXT,
      role TEXT, location TEXT, source TEXT NOT NULL, relationship_score REAL DEFAULT 0,
      created_at TEXT NOT NULL, updated_at TEXT NOT NULL
    );
  `);
  db.insert(schema.contacts).values({
